...
Background automation that monitors a VDI window and auto-clicks the GitHub Copilot "Allow" permission dialog.

## How it works

Uses Xlib to capture the target window and OpenCV template matching to detect the dialog, then clicks it automatically. Runs as a daemon with a PID file.
